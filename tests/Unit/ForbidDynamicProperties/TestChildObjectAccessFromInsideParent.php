 ...
 * inside the "parent" class, where the class being used is part of a hierarchical
...
final class TestChildObjectAccessFromInsideParent extends ForbidDynamicPropertiesTestCase
{
    ...
    {
        $obj = new $className();
        $this->assertSame($expected['isset'], $obj->testParentPropertyIsset($propertyName));
    }
    ...
    public function verifyPropertyGet($className, $propertyName, $expected)
    {
        ...
        switch ($expected['get']) {
            case self::ERR_NO_ACCESS:
                ...
                $unused = $obj->testParentPropertyAccess($propertyName);
                break;
            ...
            default:
                $this->assertSame($expected['get'], $obj->testParentPropertyAccess($propertyName));
                break;
        }
    }
    ...
    public function verifyPropertySet($className, $propertyName, $expected)
    {
        ...
        switch ($expected['set']) {
            ...
            case self::ERR_NO_ACCESS:
                ...
                $obj->testParentPropertyModification($propertyName, self::TEST_VALUE_1);
                break;
            ...
            default:
                ...
                // Verify the set succeeded.
                $this->assertSame($expected['set'], $obj->testParentPropertyAccess($propertyName));
                break;
        }
    }
    ...
    public function verifyPropertyUnset($className, $propertyName, $expected)
    {
        ...
        switch ($expected['unset']) {
            case self::ERR_NO_ACCESS:
                ...
                $obj->testParentPropertyUnset($propertyName);
                break;
            ...
            case self::ERR_UNDEFINED:
                ...
                $this->assertSame($expected['unset'], $obj->testParentPropertyAccess($propertyName));
                break;
    ...
    public function dataPropertyAccessBase()
    {
        return array(
            ...
            '[Parent] private property with default value' => array(
                ...
                'expected' => array(
                    'isset' => true,
                    'get'   => 'parent private with default',
                    'set'   => self::TEST_VALUE_1,
                    'unset' => self::ERR_UNDEFINED,
                ),
            ),
